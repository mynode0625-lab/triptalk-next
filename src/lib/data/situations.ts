...
export const SITUATIONS: Record<SituationKey, Situation[]> = {
  airport: [
    { emoji: "🛄", lv: 1, title: "체크인 카운터", desc: "좌석 요청, 수하물 무게 초과, 경유편 확인까지.",
      en: "Could I get an aisle seat, please?", ko: "통로 쪽 좌석으로 부탁드려도 될까요?" },
    { emoji: "🛂", lv: 3, title: "입국 심사", desc: "방문 목적과 체류 기간을 흔들림 없이 답하기.",
      en: "I'm here for sightseeing, for about ten days.", ko: "관광 목적으로 열흘 정도 머뭅니다." },
    ...
    { emoji: "💱", lv: 1, title: "환전과 면세점", desc: "환율 확인, 세금 환급 창구 찾기.",
      en: "Where can I get my tax refund processed?", ko: "세금 환급은 어디서 받을 수 있나요?" }
  ],
  hotel: [
    ...
    { emoji: "🚿", lv: 2, title: "시설 문제 신고", desc: "온수, 에어컨, 와이파이가 안 될 때.",
      en: "The hot water isn't working in my room.", ko: "방에 온수가 나오지 않습니다." },
  ...
  food: [
    ...
    { emoji: "📋", lv: 2, title: "메뉴 주문과 추천", desc: "추천 요청, 재료 확인, 굽기 정도 말하기.",
      en: "What would you recommend for someone who likes seafood?", ko: "해산물 좋아하는 사람에게 뭘 추천하시나요?" },
  ...
  city: [
    { emoji: "🚖", lv: 2, title: "택시 · 차량 호출", desc: "목적지 설명, 경로와 요금 확인.",
      en: "Could you take me to this address, please?", ko: "이 주소로 가주시겠어요?" },
  ...
  trouble: [
    ...
    { emoji: "👮", lv: 3, title: "도난 · 분실 신고", desc: "경찰서에서 상황 설명하고 확인서 받기.",
      en: "My wallet was stolen on the subway.", ko: "지하철에서 지갑을 도난당했습니다." },
    ...
    { emoji: "💸", lv: 2, title: "결제 오류 · 이중 청구", desc: "카드가 안 될 때, 두 번 결제됐을 때.",
      en: "I think I was charged twice for this.", ko: "이거 두 번 결제된 것 같습니다." },
